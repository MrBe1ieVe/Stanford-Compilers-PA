...
<INITIAL,COMMENT_LINE,COMMENT_BLOCK>"(*" { ++comment_depth; BEGIN COMMENT_BLOCK; }

<COMMENT_BLOCK>[^\n(*)]* {}

<COMMENT_BLOCK>[()*]	{}

<COMMENT_BLOCK>"*)"	{ --comment_depth; if(comment_depth == 0) BEGIN INITIAL;}

<COMMENT_BLOCK>\n	{ curr_lineno++; }
	
<COMMENT_BLOCK><<EOF>>	{ BEGIN INITIAL; cool_yylval.error_msg = "EOF in comment";return ERROR; }

"*)"			{ BEGIN INITIAL; cool_yylval.error_msg = "Unmatched *"; return ERROR; }
...
<STR>\n			{ BEGIN INITIAL; ++curr_lineno; cool_yylval.error_msg = "Unterminated string"; return ERROR; }

<STR><<EOF>>		{ BEGIN INITIAL; yyrestart(yyin); cool_yylval.error_msg = "EOF in string"; return ERROR; }
